# Launch Options
`+exec autoexec.cfg -1024 -768 -freq 144 -threads 8 +cl_forcepreload 1 +gpu_mem_level 0 +mat_picmip 2 +r_drawparticles 0 -nojoy -novid -noborder -full -allow_third_party_software  -softparticlesdefaultoff`

# Broken Launch options
`-high`
`+mat_queue_mode 2`
`+violence_hblood 0`
